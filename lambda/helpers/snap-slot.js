const teams = [
  { name: 'Arsenal FC', synonyms: ['arsenal', 'arsenal fc', 'the gunners'] },
  { name: 'AFC Bournemouth', synonyms: ['afc bournemouth', 'bournemouth'] },
  { name: 'Brighton & Hove Albion', synonyms: ['brighton & hove albion', 'brighton and hove albion', 'brighton', 'the seagulls'] },
  ...
  { name: 'Manchester United FC', synonyms: ['manchester united fc', 'manchester united', 'man united', 'man utd'] },
  { name: 'Newcastle United FC', synonyms: ['newcastle united fc', 'newcastle united', 'newcastle utd', 'newcastle', 'the magpies'] },
  { name: 'Southampton FC', synonyms: ['southampton fc', 'southampton', 'the saints'] },
  { name: 'Stoke City FC', synonyms: ['stoke city fc', 'stoke city', 'stoke', 'the potters'] },
  { name: 'Swansea City FC', synonyms: ['swansea city fc', 'swansea city', 'swansea', 'the swans'] },
  { name: 'Tottenham Hotspur FC', synonyms: ['tottenham hotspur fc', 'tottenham hotspur', 'tottenham hotspurs', 'tottenham', 'spurs'] },
  { name: 'Watford FC', synonyms: ['watford fc', 'watford', 'the hornets'] },
  { name: 'West Bromwich Albion FC', synonyms: ['west bromwich albion fc', 'west bromwich albion', 'west bromwich', 'west brom'] },
  { name: 'West Ham United FC', synonyms: ['west ham united fc', 'west ham united', 'west ham utd', 'west ham utd fc', 'west ham fc', 'west ham', 'the hammers'] }
];
