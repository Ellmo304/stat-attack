const teams = [
  ...
  { name: 'Cardiff City FC', synonyms: ['cardiff city', 'cardiff'] },
  ...
  { name: 'Fulham FC', synonyms: ['fulham'] },
  ...
  { name: 'Wolverhampton Wanderers FC', synonyms: ['wolverhampton wanderers', 'wolverhampton', 'wolves'] },
